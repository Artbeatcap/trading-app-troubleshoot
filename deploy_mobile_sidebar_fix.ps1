...
Write-Host "   ssh root@167.88.43.61 'cp /home/tradingapp/trading-analysis/templates/base.html.backup.* /home/tradingapp/trading-analysis/templates/base.html'" -ForegroundColor Gray
