"""
Final Market Brief Generator - No Fallback Data, No Generation When Insufficient Data
Uses only real APIs: Tradier for stock prices, alternative news sources
"""
...
def fetch_news() -> List[Dict[str, Any]]:
    """Fetch news - currently only Finnhub"""
...
def fetch_stock_prices() -> Dict[str, Dict[str, float]]:
    """Fetch stock prices with priority: Tradier -> Finnhub -> None"""
...
if __name__ == "__main__":
    print("🚀 Starting Final Market Brief Generation (No Fallback Data)...")
    print("=" * 70)
    ...
    if not headlines:
        ...
        print("Please check Finnhub API token and try again")
        exit(1)
