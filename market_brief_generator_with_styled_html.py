"""
Market Brief Generator with GPT News Integration and Beautiful HTML Styling
Uses ChatGPT API to fetch and summarize market headlines with proper HTML formatting
"""
...
def generate_html_content_with_summary(summary: str, headlines: List[Dict[str, Any]], 
    ...
    """Generate beautiful HTML content with proper styling"""
    ...
    if subscriber_summary:
        ...
        <div class="subscriber-summary">
            <h3 style="margin-top: 0; color: #2c3e50; font-size: 20px;">📊 Subscriber Summary</h3>
            <div style="white-space: pre-wrap; line-height: 1.45; color: #2c3e50;">
                {subscriber_summary}
            </div>
        </div>
    ...
    if gapping_stocks:
        ...
        for stock in gapping_stocks[:5]:
            ...
            <div style="margin-bottom: 10px;">
                <strong style="color: #2c3e50;">{ticker}</strong>: {move} - {why}
            </div>"""
...
if __name__ == "__main__":
    print("🚀 Starting Market Brief Generation with GPT News and Beautiful HTML...")
    print("=" * 70)
