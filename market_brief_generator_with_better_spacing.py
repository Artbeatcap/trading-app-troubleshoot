"""
Market Brief Generator with GPT News Integration and Better Headline Spacing
Uses ChatGPT API to fetch and summarize market headlines with enhanced spacing
"""
...
def generate_html_content_with_summary(summary: str, headlines: List[Dict[str, Any]], 
    ...
    if headlines:
        ...
        headlines_start = summary_html.find('## Key Market Headlines')
        if headlines_start != -1:
            # Find where the headlines section ends
            headlines_end = summary_html.find('## Technical Analysis', headlines_start)
            if headlines_end == -1:
            ...
            # Create formatted headlines HTML with better spacing
            ...
            for i, headline in enumerate(headlines[:7], 1):
                ...
                <div class="headline-item">
                    ...
                    <div class="headline-content">
                        ...
                        <div class="headline-source">Source: {headline.get('source', 'Market News')}</div>
                        <div class="headline-summary">{headline.get('summary', '')}</div>
                    </div>
                </div>"""
...
if __name__ == "__main__":
    print("🚀 Starting Market Brief Generation with Better Headline Spacing...")
    print("=" * 70)
